...
export function Section2() {
  return (
    <>
      <div className="border bg-white rounded-3xl mt-10 px-10 py-24  grid lg:grid-cols-3 gap-5">
        ...
        <div className="border bg-gray-100 rounded-xl mt-10 px-5 py-8">
          ...
          <div className="border text-lg bg-gray-50 rounded-xl mt-10 px-5 py-8">
            <p>Included</p>
